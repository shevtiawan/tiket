 ...
 * Tiket class
 *
 * @author		Andri Setiawan <shevtiawan@gmail.com>
 * @version		0.0.1
 * @copyright	Copyright (c), Andri Setiawan. All rights reserved.
 * @license		BSD License
 */
class Tiket
{
...
// class methods
    ...
    {
        $this->setConsumerKey( Config::get('tiket::CONSUMER_KEY') );
        $this->setConsumerSecret( Config::get('tiket::CONSUMER_SECRET') );
    }

    public function tesapa()
    {
        return "tes ok";
    }
